...
set_property IOSTANDARD LVCMOS33 [get_ports {difficulty[0]}]
set_property PACKAGE_PIN V16 [get_ports {difficulty[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {difficulty[1]}]
set_property PACKAGE_PIN W16 [get_ports {difficulty[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {difficulty[2]}]
set_property PACKAGE_PIN W17 [get_ports check_record]
   set_property IOSTANDARD LVCMOS33 [get_ports check_record]
...
# set_property PACKAGE_PIN T17 [get_ports {sensor[0]}]
 #   set_property IOSTANDARD LVCMOS33 [get_ports {sensor[0]}]
 #set_property PACKAGE_PIN U17 [get_ports {sensor[2]}]
...
## Sch name = JA7
 set_property PACKAGE_PIN H1 [get_ports {sensor[4]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sensor[4]}]
## Sch name = JA8
 set_property PACKAGE_PIN K2 [get_ports {sensor[5]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {sensor[5]}]
## Sch name = JA9
...
## Pmod Header JC
## Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports coin_motor_pwm]
 #  set_property IOSTANDARD LVCMOS33 [get_ports coin_motor_pwm]
## Sch name = JC2
# set_property PACKAGE_PIN M18 [get_ports coin]
...
## Sch name = JC4
 set_property PACKAGE_PIN P18 [get_ports coin]
    set_property IOSTANDARD LVCMOS33 [get_ports coin]
## Sch name = JC7
# set_property PACKAGE_PIN L17 [get_ports coin]
