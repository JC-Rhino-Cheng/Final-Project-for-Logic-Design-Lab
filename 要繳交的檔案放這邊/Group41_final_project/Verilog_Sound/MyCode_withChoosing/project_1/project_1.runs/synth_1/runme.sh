...
HD_PWD='D:/Project/Verilog_Sound/MyCode_withChoosing/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rhinos_speaker.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rhinos_speaker.tcl
