...
HD_PWD='D:/Project/Verilog_Sound/MyCode_withChoosing/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rhinos_speaker.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rhinos_speaker.tcl -notrace
