...
HD_PWD='D:/Project/Verilog_VGA/Project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rhinos_Project_VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rhinos_Project_VGA.tcl -notrace
